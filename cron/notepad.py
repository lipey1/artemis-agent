...
Write path is the CLI (``artemis cron notepad <job_id> set <key> <value>``),
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`artemis cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `artemis cron notepad {job_id} delete "
