"""
Cron job scheduling system for Artemis Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    artemis gateway install    # Install as a user service
    sudo artemis gateway install --system  # Linux servers: boot-time system service
    artemis gateway            # Or run in foreground
