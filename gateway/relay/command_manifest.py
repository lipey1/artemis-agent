...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Artemis session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Artemis session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Artemis agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Artemis Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Artemis gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Artemis session in it",
