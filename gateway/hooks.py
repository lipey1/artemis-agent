...
Hooks are discovered from ~/.artemis/hooks/ directories, each containing:
...
HOOKS_DIR = get_artemis_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"artemis_hook_{hook_name}"
