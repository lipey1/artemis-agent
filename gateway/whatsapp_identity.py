...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ARTEMIS_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_artemis_dir("platforms/whatsapp/session", "whatsapp/session")
