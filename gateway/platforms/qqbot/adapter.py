...
class QQAdapter(BasePlatformAdapter):
    ...
    async def _send_identify(self) -> None:
        ...
        identify_payload = {
            ...
            "d": {
                ...
                "properties": {
                    "$os": "macOS",
                    "$browser": "artemis-agent",
                    "$device": "artemis-agent",
                },
            },
        }
        try:
    ...
    def _write_update_response(answer: str, operator: str = "") -> None:
        ...
        ``artemis update --gateway`` watcher polls this file for a ``y``/``n``
    ...
    def _resolve_stt_config(self) -> Optional[Dict[str, str]]:
        ...
        # 2. QQ-specific env vars (set by `artemis setup gateway` / `artemis gateway`)
    ...
    async def send_update_prompt(
        ...
        ``gateway/run.py``'s ``artemis update --gateway`` watcher. Button
