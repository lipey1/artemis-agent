...
Entry point: ``artemis whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``artemis_cli/main.py``).
...
Artemis gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Artemis to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Artemis needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Artemis gateway in another terminal:")
    print("         artemis gateway")
    print()
    ...
    print()
    print("  Docs: https://artemis-agent.nousresearch.com/docs/user-guide/")
