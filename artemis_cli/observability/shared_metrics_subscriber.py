"""Relay subscriber for the persisted Artemis shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Artemis counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Artemis shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
