"""Durable aggregation and local export for Artemis shared metrics."""
...
from artemis_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "artemis.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_artemis_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "artemis_version": row["artemis_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Artemis processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "artemis_version": period_row["artemis_version"],
