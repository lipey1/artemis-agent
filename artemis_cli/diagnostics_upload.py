"""Client for uploading ``artemis debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``artemis debug share``.
...
NAS_BASE = os.environ.get(
    "ARTEMIS_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "artemis-agent/debug-share"
