...
from artemis_cli.proxy.adapters.base import UpstreamAdapter
from artemis_cli.proxy.adapters.nous_portal import NousPortalAdapter
from artemis_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``artemis proxy start --provider <name>`` CLI flag.
