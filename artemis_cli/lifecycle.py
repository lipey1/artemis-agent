"""Artemis lifecycle dispatch for first-party observers and plugins."""
...
def has_hook(hook_name: str) -> bool:
    ...
    try:
        from artemis_cli.observability import handles_hook
