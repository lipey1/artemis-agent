"""``artemis_cli/_scan_venv_blockers.py`` — Standalone venv-process scan for JSON consumption.

Invoked by the Desktop Electron app::

    venv\\Scripts\\python.exe -m artemis_cli._scan_venv_blockers
...
def main() -> None:
    ...
    try:
        from artemis_cli.main import _detect_venv_python_processes  # noqa: PLC0415
