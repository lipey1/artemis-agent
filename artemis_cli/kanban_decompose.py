...
Invoked by ``artemis kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Artemis Agent board.
...
def _profile_author() -> str:
    """Mirror of ``artemis_cli.kanban._profile_author``."""
    return (
