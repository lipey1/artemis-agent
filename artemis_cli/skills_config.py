"""
Skills configuration for Artemis Agent.
`artemis skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.artemis/config.yaml under:
...
from artemis_cli.config import cfg_get, load_config, save_config
from artemis_cli.colors import Colors, color
from artemis_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `artemis skills`."""
    from artemis_cli.curses_ui import curses_checklist
