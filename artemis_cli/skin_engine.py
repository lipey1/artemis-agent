"""Artemis skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Artemis itself) customize the
visual appearance across the CLI, the TUI, and the desktop GUI from a single
file. Skins are defined as YAML files in ~/.artemis/skins/ or as built-in presets.
...
``resolve_skin`` / ``skin.changed``). A skin dropped in ~/.artemis/skins/ therefore
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Artemis Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Artemis "       # Response box header label
...
.. code-block:: python
    ...
    from artemis_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Artemis Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.artemis/skins/
...
Drop a YAML file in ``~/.artemis/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ARTEMIS_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ARTEMIS_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Artemis — cyan",
        # Dark-authored cyan palette for Artemis TUI + classic CLI.
        "colors": {
            ...
            "status_bar_text": "#A5F3FC",
            "status_bar_strong": "#67E8F9",
            "status_bar_dim": "#155E75",
            "status_bar_good": "#5EEAD4",
            "status_bar_warn": "#22D3EE",
            "status_bar_bad": "#FB923C",
            "status_bar_critical": "#FF6B6B",
            "session_label": "#22D3EE",
            "session_border": "#0891B2",
            "completion_menu_bg": "#0B1220",
            "completion_menu_current_bg": "#164E63",
            "selection_bg": "#155E75",
            "shell_dollar": "#22D3EE",
            "voice_status_bg": "#0B1220",
        },
        # Light overlay: teal ladder on white (readable, not neon).
        "light_colors": {
            "banner_title": "#0E7490",
        ...
        "branding": {
            ...
            "welcome": "Welcome to Artemis Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
...
def get_prompt_toolkit_style_overrides() -> Dict[str, str]:
    ...
    return {
        ...
        # Session-title chip: skin accent (not hardcoded gold).
