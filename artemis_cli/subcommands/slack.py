"""``artemis slack`` subcommand parser.
...
def build_slack_parser(subparsers, *, cmd_slack: Callable) -> None:
    ...
    slack_parser = subparsers.add_parser(
        ...
        description="Slack integration helpers for Artemis.",
    )
    ...
    slack_manifest.add_argument(
        ...
        "writes to $ARTEMIS_HOME/slack-manifest.json.",
    )
    slack_manifest.add_argument(
        "--name",
        default=None,
        help='Bot display name (default: "Artemis")',
    )
    slack_manifest.add_argument(
        "--description",
        default=None,
