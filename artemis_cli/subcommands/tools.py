"""``artemis tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'artemis tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # artemis tools list [--platform cli]
    ...
    # artemis tools disable <name...> [--platform cli]
    ...
    # artemis tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `artemis tools` runs after you pick a provider that\n"
