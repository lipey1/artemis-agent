...
class LineAdapter(BasePlatformAdapter):
    ...
    async def _handle_media(self, request) -> Any:
        ...
        try:
            ...
            artemis_home = Path.home().joinpath(".hermes").resolve()
...
def interactive_setup() -> None:
    ...
    one optional public URL. Writes to ``~/.hermes/.env`` via ``artemis_cli.config``.
    """
    print()
    ...
    try:
        ...
        print("artemis_cli.config not available; set LINE_* vars manually in ~/.hermes/.env")
        return
