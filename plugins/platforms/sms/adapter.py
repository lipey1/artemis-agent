...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Artemis gateway adapter.

    Each inbound phone number gets its own Artemis session (multi-tenant).
...
# static dict in artemis_cli/gateway.py, and the _send_sms dispatch in
