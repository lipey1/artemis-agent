...
Config: ~/.artemis/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.artemis/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_artemis_home()`` helper (ARTEMIS_HOME-aware and
...
RULES_FILE = get_artemis_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_artemis_home() / "feishu_comment_pairing.json"
