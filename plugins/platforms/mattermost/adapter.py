...
required — uses aiohttp which is already a Artemis dependency.
...
def interactive_setup() -> None:
    ...
    ``artemis_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Artemis delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # artemis_cli/setup.py::_setup_mattermost function.
