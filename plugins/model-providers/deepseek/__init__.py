...
the contract that subsequent turns echo it back; combined with how Artemis
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Artemis remaps
the retired IDs in ``artemis_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Artemis, so they are not listed here.
    """
