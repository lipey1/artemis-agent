...
# When the user hasn't picked a reasoning effort, Artemis passes
...
# ON at this effort — matching the "medium (default)" that Artemis' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Artemis' effort vocabulary onto Solar's accepted set. xhigh/max/
