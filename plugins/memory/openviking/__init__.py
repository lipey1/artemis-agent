...
def _openviking_server_log_path() -> Path:
    try:
        ...
        home = Path(os.environ.get("ARTEMIS_HOME", "")).expanduser() if os.environ.get("ARTEMIS_HOME") else Path.home() / ".hermes"
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, artemis_home: str, config: dict) -> None:
        ...
        hermes_home_path = Path(artemis_home)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        if not artemis_home:
            try:
                ...
                artemis_home = str(Path.home() / ".hermes")
