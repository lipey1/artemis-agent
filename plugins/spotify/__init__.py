...
``_check_spotify_available()`` — when the user has not run ``artemis auth
spotify``, the tools remain registered (so they appear in ``artemis
...
The Spotify auth flow (``artemis auth spotify``), CLI plumbing, and docs
