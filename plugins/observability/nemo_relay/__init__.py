...
def _load_settings() -> _Settings:
    ...
    return _Settings(
        ...
        atof_filename=_env("ARTEMIS_NEMO_RELAY_ATOF_FILENAME") or "hermes-atof.jsonl",
        ...
        atif_filename_template=_env("ARTEMIS_NEMO_RELAY_ATIF_FILENAME_TEMPLATE") or "hermes-atif-{session_id}.json",
        atif_subagent_export_mode=_atif_subagent_export_mode(),
        atif_agent_name=_env("ARTEMIS_NEMO_RELAY_ATIF_AGENT_NAME") or "Hermes Agent",
