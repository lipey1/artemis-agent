...
import { type BillingBlock, skillInvocationText } from '@artemis/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/artemis'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @artemis/shared BillingBlock).
