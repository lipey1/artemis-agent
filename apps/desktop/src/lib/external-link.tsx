...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|artemis):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.artemisDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.artemisDesktop?.openExternal?.(href)
  }
}
