...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/artemis-agent')).toBe('~/www/artemis-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/artemis-agent')).toBe('artemis-agent')
    expect(pathLeaf('~/www/artemis-agent')).toBe('artemis-agent')
