 ...
 * plugins resolve `@artemis/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ARTEMIS_PLUGIN_SDK__: sdk,
  __ARTEMIS_REACT__: React,
  __ARTEMIS_REACT_JSX__: jsxRuntime,
  __ARTEMIS_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@artemis/plugin-sdk': shimUrl('__ARTEMIS_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ARTEMIS_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ARTEMIS_REACT_JSX__'),
    react: shimUrl('__ARTEMIS_REACT__')
  }
