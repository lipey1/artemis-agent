 ...
 * `<artemis home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'artemis.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'artemis.desktop.disabledPlugins.v1'
