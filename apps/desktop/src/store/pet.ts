...
export interface PetInfo {
  ...
  // the Artemis "run" activity state uses the in-place running row).
 ...
 * ARTEMIS_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'artemis.desktop.pet-roam.v1'
