...
const POPOUT_STORAGE_KEY = 'artemis.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'artemis.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'artemis.desktop.composerPopout.position'
