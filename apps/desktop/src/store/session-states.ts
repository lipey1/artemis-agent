...
const TILES_KEY = 'artemis.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'artemis.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __ARTEMIS_LAYOUT_TREE__).
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ARTEMIS_SESSION_TILES__ = {
