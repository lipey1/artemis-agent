...
export function openPullRequest(pr: ArtemisBranchPullRequest): void {
  if (pr.url) {
    void window.artemisDesktop?.openExternal?.(pr.url)
  }
}
 ...
 *  never a status dot. */
export function PrTag({ className, pr }: { className?: string; pr: ArtemisBranchPullRequest }) {
