...
import { deleteCronJob, getCronJobRuns, pauseCronJob, resumeCronJob, type SessionInfo } from '@/artemis'
...
import type { CronJob } from '@/types/artemis'
...
export function SidebarCronJobsSection({
  ...
  return (
    <SidebarGroup className="shrink-0 p-0 pb-1">
      <div className="group/section flex shrink-0 items-center justify-between px-2 pb-1 pt-1.5">
        <button
          className="group/section-label flex w-fit min-w-0 items-center gap-1 bg-transparent text-left leading-none"
          onClick={onToggle}
          type="button"
        >
          <SidebarPanelLabel icon={<Codicon name="clock" size="0.75rem" />}>{label}</SidebarPanelLabel>
          <DisclosureCaret
