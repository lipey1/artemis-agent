...
import type { ArtemisGitBranch } from '@/global'
...
const branchActionLabel = (branch: ArtemisGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<ArtemisGitBranch[]>([])
  ...
  const convert = async (branch: ArtemisGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
