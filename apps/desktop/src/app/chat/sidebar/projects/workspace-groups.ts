...
import type { ProjectInfo, SessionInfo } from '@/artemis'
 ...
 * repo shows its branches/worktrees even when they have no Artemis sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ArtemisGitWorktree[]
): SidebarSessionGroup[] {
