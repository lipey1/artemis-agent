...
const FOCUS_EVENT = 'artemis:composer-focus'
const INSERT_EVENT = 'artemis:composer-insert'
const INSERT_REFS_EVENT = 'artemis:composer-insert-refs'
const SUBMIT_EVENT = 'artemis:composer-submit'
const VOICE_TOGGLE_EVENT = 'artemis:composer-voice-toggle'
const MODEL_MENU_EVENT = 'artemis:composer-model-menu'
