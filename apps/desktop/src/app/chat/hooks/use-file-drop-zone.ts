...
import { type DroppedFile, extractDroppedFiles, ARTEMIS_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, ARTEMIS_PATHS_MIME) ? 'files' : null
