...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/artemis'
...
const VERSION = 3
const PREFIX = 'HML' // "Artemis Memory Loadout" — namespaces our codes like WoW's leading bytes.
