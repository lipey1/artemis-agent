...
const TAKEOVER_KEY = 'artemis.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Artemis can't clear via the API — the user
 *  sees exactly what runs instead of Artemis silently deleting their creds. */
