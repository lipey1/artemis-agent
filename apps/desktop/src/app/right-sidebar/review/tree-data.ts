import type { ArtemisReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ArtemisReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ArtemisReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
