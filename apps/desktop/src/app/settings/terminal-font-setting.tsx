...
import { saveArtemisConfig } from '@/artemis'
...
function fontFamilyFromConfig(config: ArtemisConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useArtemisConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<ArtemisConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setArtemisConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="artemis-terminal-font-families"
          ...
          <datalist id="artemis-terminal-font-families">
