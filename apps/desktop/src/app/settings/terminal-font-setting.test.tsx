...
vi.mock('@/artemis', () => ({
  saveArtemisConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setArtemisConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useArtemisConfigRecord: () => ({ data: mocks.loadedConfig })
}))
