...
import type { ConfigFieldSchema, ArtemisConfigRecord, ToolsetInfo } from '@/types/artemis'
...
export function getNested(obj: ArtemisConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ArtemisConfigRecord, path: string, value: unknown): ArtemisConfigRecord {
...
function personalityOptions(config: ArtemisConfigRecord): string[] {
...
function commandProviderNames(config: ArtemisConfigRecord, section: 'tts' | 'stt'): string[] {
