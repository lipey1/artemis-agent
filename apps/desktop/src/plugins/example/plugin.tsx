 ...
 * `src/plugins/` with a `plugin.tsx` that default-exports a `ArtemisPlugin` is
 ...
 *
 * The ONLY import surface is `@artemis/plugin-sdk` (lint-enforced) — the
