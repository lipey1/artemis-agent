...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@artemis/plugin-sdk'
...
/** First-class Artemis projects, for scoping a board's default workspace. */
