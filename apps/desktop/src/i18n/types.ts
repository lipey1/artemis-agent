...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshArtemisPathTitle: string
      sshArtemisPathDesc: string
      sshArtemisPathPlaceholder: string
  ...
  commandCenter: {
    ...
    artemisActiveSessions: (version: string, count: number) => string
