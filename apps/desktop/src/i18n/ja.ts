...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      backdropDesc: '会話の背後に表示される淡い「アダムの創造」の画像。',
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'リモートホストに Artemis がインストールされていません。リモートでインストールする（curl -fsSL https://github.com/lipey1/artemis-agent/releases/latest | sh）か、Artemis パスを設定してください。',
      sshErrPlatform:
