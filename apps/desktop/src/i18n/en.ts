...
export const en: Translations = {
  ...
  boot: {
    ready: 'Artemis is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Artemis settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingArtemisDesktop: 'Starting Artemis…'
    },
    errors: {
      backgroundExited: 'Artemis background process exited.',
      backgroundExitedDuringStartup: 'Artemis background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Artemis backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateArtemis: 'Update Artemis',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Artemis.',
    ...
    native: {
      ...
      inputBody: 'Artemis is waiting for your response.',
      turnDoneTitle: 'Artemis finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Artemis defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the Artemis backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Artemis backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Artemis is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Artemis asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Artemis was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Artemis was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Artemis follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Artemis is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Artemis, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Artemis checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Artemis configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Artemis.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Artemis backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset ARTEMIS_DESKTOP_REMOTE_URL / ARTEMIS_DESKTOP_REMOTE_URL (and matching TOKEN) to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Artemis backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Artemis backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Artemis Cloud',
      cloudDesc: 'Sign in once to Artemis Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Artemis Cloud',
      cloudSignIn: 'Sign in to Artemis Cloud',
      cloudSignedIn: 'Signed in to Artemis Cloud',
      cloudNeedsSignIn: 'Sign in to Artemis Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Artemis Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Artemis Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Artemis Cloud',
      cloudSignedOutMessage: 'Cleared the Artemis Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /artemis.',
      ...
      restartingMessage: 'Artemis will reconnect using the saved settings - the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Artemis ${version}` : ''}`,
      ...
      sshDesc:
        'Artemis is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshArtemisPathTitle: 'Artemis path (optional)',
      sshArtemisPathDesc: 'Full path to the remote artemis binary. Blank = auto-detect.',
      sshArtemisPathPlaceholder: 'auto-detect',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Artemis found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Artemis runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Artemis is not installed on the remote host. Install it there or set the Artemis path in SSH connection settings.',
      sshErrPlatform:
        'Unsupported remote platform. Artemis SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Artemis on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Point Artemis at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a subscription - sign in to the Portal to activate.',
      nousAuthNeededTitle: 'Sign in to Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to the Portal.`,
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via artemis curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Artemis builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Artemis to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Artemis to generate pets.',
      backgroundHint: 'You can close this — Artemis will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Artemis desktop' },
    ...
    artemisActiveSessions: (version, count) => `Artemis ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@artemis:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Artemis environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Artemis will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Artemis backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Artemis. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Artemis...',
    placeholderReconnecting: 'Reconnecting to Artemis…',
    ...
    attachUrlDesc: 'Artemis will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Artemis to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Artemis…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Artemis…',
    ...
    unsupportedMessage: 'This version of Artemis can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Artemis from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Artemis will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Artemis desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Artemis updater takes over in its own window and reopens Artemis automatically when it’s done. Please don’t reopen Artemis yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Artemis reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Artemis reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Artemis needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Artemis Desktop',
    setupChoiceDesc:
      'Connect this app to an Artemis gateway you already run, or install Artemis locally on this computer.',
    connectExistingTitle: 'Connect to existing Artemis',
    ...
    installLocalTitle: 'Install Artemis locally',
    installLocalDesc: 'Download Artemis, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Artemis Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Artemis',
    remoteSetupDesc: 'Enter your gateway URL. Artemis Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Artemis gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/artemis',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Artemis gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Artemis',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Artemis CLI or desktop instance is running. Stop any running Artemis instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. Artemis is preparing dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Artemis",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Artemis is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Artemis…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Artemis',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Artemis at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Artemis connects automatically',
    ...
    authorizeThere: 'Authorize Artemis there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Artemis there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Artemis v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Artemis Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Artemis will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Artemis is restarting...',
      askRestart: 'Ask Artemis to restart the server',
      lookingRestart: taskId => `Artemis is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Artemis is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Artemis finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Artemis could not restart the server.',
      stillWorking:
        'Artemis is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Artemis is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Artemis gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.artemis/config.yaml). Artemis won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Artemis needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Artemis needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Artemis to use Save Image.',
    restartToSaveImages: 'Restart Artemis to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `artemis gateway` running?'
    }
  },
