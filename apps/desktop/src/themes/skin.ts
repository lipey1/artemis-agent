/**
 * Artemis skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ARTEMIS_HOME/skins/` (or a
 * built-in) resolved by `artemis_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Artemis authors from a prompt lights up all three surfaces from one file.
 *
...
import type { ArtemisSkin, SkinColors } from '@artemis/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: ArtemisSkin): DesktopTheme | null {
