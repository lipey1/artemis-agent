...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @artemis/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@artemis/shared'],
              message: 'Plugins import only @artemis/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
