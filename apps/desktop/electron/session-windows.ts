...
// by main.ts (`setBackgroundThrottling` driven by the merged `artemis:active-work`
...
// (the "Artemis idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Artemis" wake word has NO preceding click,
