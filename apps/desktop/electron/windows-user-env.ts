...
// even though a fresh shell — and the Artemis CLI — sees it immediately. The
// desktop's ARTEMIS_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\artemis. Reading
...
//       ARTEMIS_HOME    REG_SZ    F:\Artemis\data
//
