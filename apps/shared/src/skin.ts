/**
 * Canonical Artemis skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ARTEMIS_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`artemis_cli/skin_engine.py`),
 ...
 *   • CLI     → `artemis_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
