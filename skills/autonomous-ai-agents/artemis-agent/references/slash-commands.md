...
Registry of record: `artemis_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Artemis config+state snapshots (CLI)
...
/update                  Update Artemis to latest
