/**
 * Artemis desktop plugin template. Save as:
 *   <artemis home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <artemis home> is ~/.artemis by default, or ~/.artemis/profiles/<name>
 * when running a named profile (`artemis -p <name>`). Run `artemis doctor` (or
 ...
 * Only these imports resolve: @artemis/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@artemis/plugin-sdk'
