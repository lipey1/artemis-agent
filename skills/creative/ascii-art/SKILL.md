...
```bash
python3 -m pyfiglet "ARTEMIS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ARTEMIS&font=Slant" | boxes -d stone
```
