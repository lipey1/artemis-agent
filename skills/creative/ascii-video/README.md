...
Built for [Artemis Agent](https://github.com/lipey1/artemis-agent). Usable in any coding agent. Canonical source lives here; synced to [`lipey1/artemis-agent/skills/creative/ascii-video`](https://github.com/lipey1/artemis-agent/tree/main/skills/creative/ascii-video) via PR.
