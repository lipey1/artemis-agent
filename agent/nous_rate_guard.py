...
(3 SDK retries x 3 Artemis retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_artemis_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".artemis")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Artemis, ...) behind one endpoint.  A 429 can mean either:
