"""Vertex AI (Google Cloud) adapter for Artemis Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Artemis to use Gemini models via Google Cloud with
...
# who installed plain `artemis-agent` and only later selected a Gemini model.
try:
