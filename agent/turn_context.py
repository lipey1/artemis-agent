...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``artemis logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Artemis only initiates compaction in "artemis" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Artemis preflight compression for codex app-server "
                "(mode=%s); Artemis will not start thread compaction here.",
