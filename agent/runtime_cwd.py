...
_SESSION_CWD: ContextVar = ContextVar("ARTEMIS_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Artemis
    # source tree itself, which is a legitimate workspace when the user is
    # developing Artemis (per-surface policy for fallback-picked directories
