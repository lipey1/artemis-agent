"""Core NeMo Relay adapter for Artemis tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Artemis tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Artemis Relay tool execution cannot run on an active event-loop thread"
    )
