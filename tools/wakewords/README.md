...
`hey_artemis.onnx` / `hey_artemis.tflite` — the on-device "Hey Artemis" hotword
...
- **Label:** the model registers as `hey_artemis` (matches the filename).
