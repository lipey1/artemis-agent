...
def has_xai_credentials() -> bool:
    ...
    hot-paint paths (``artemis tools`` repaint, tool-registration scans,
    ...
    try:
        ...
        auth_path = get_artemis_home() / "auth.json"
...
def maybe_mark_xai_storage_notice_seen(section_name: str) -> Optional[str]:
    ...
    try:
        ...
        marker_dir = get_artemis_home() / "state"
    ...
    *,
    ...
    try:
        ...
        override_base_url = str(
            get_env_value("ARTEMIS_XAI_BASE_URL")
