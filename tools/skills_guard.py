...
Trust levels:
  - builtin:   Ships with Artemis. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.artemis/\.env|\~/\.artemis/\.env',
     "artemis_env_access", "critical", "exfiltration",
     "directly references Artemis secrets file"),
    ...
    (r'\.artemis/config\.yaml|\.artemis/SOUL\.md',
     "artemis_config_mod", "critical", "persistence",
     "references Artemis configuration files directly"),
...
# scan. `.skillignore` is the Artemis-native name; `.clawhubignore` is honored
