...
the get_anchored_view / get_messages_around primitives in artemis_state.
...
# Third-party integrations tag their sessions with ARTEMIS_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Artemis conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Artemis renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Artemis conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Artemis profile's database "
