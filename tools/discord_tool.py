...
Only included in the artemis-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Artemis-Agent (https://github.com/NousResearch/artemis-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_artemis_home() / "cache" / "discord_capabilities.json"
