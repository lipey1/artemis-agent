...
def _profile_user_agent() -> str:
    """Return a ``artemis-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from artemis_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"artemis-cli/{_ver}"
    except Exception:
        return "artemis-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # artemis-cli UA so the catalog endpoint is reachable.
